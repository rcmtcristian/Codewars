...
// Solution 1:
function cantBeatSoJoins(numbers) {
...
// Solution 1:
function cantBeatSoJoinss(numbers: number[][]): number[] {
  return ([] as number[]).concat(...numbers.sort((a, b) => (b.reduce((a, b) => a + b, 0)) - (a.reduce((a, b) => a + b, 0))));
}

// Solution 2:
function cantBeatSoJoinsss(numbers: number[][]): number[] {
...
// Other solutions:
export function cantBeatSoJoinssss(numbers: number[][]): number[] {
