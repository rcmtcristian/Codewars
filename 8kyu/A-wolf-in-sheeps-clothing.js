...
//new solution 
function warnTheSheep(queue) {
  const placeInLine = queue.reverse().indexOf('wolf');
  return placeInLine === 0 ? "Pls go away and stop eating my sheep" : `Oi! Sheep number ${placeInLine}! You are about to be eaten by a wolf!`
}
